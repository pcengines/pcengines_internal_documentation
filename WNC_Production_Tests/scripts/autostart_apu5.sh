#!/bin/bash
	...
	board_name="apu5"
	bios_file="./coreboot/apu5_v4.0.17.rom"
	bios_date="20180511"
...
# *************************************************************************************
#  flash LPC11C11 only on apu5 (restarting LPC11C11 kills V3A -> reboot)
# *************************************************************************************
	...
	then
		...
		echo_fail "reset LPC11C14 now"
		echo_fail "shorten pins 4+5 on J5"
		lpc21isp -bin $lpc_fw /dev/ttyS1 115200 12000
		let reboot++		
	else
...
# *************************************************************************************
#  check button S1 (not needed on apu5)
# *************************************************************************************
